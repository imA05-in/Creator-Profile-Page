...
export default function Content() {
  ...
  return (
    <div className="h-full flex flex-col md:flex-row gap-2 ">
      {data.map((profile) => (
        <NavLink
          className={`bg-gray-100 border-2 border-[#2A2F3A] rounded-xl px-2 flex items-center justify-center h-full bg-linear-to-t from-black/60 to-black/10 active:outline`}
